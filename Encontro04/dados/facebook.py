...
DRIVER_PATH = r'../../../../../../../../Downloads/chromedriver'
WINDOW_WIDTH = 1024
WINDOW_HEIGHT = 768
SLEEP_TIME = 6
ROOT_USERNAME = 'gabriel.moreira.98892'
...
def main():
    ...
    sleep(SLEEP_TIME)
    browser.find_element_by_id('email').send_keys('gabriel.moreira98@hotmail.com')
    browser.find_element_by_id('pass').send_keys('qwerty123456')
